...
ALTER TABLE orders ADD CONSTRAINT fk_shipment_order FOREIGN KEY (shipment_id) REFERENCES shipments(id);

ALTER TABLE payments ADD CONSTRAINT fk_user_payment FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE shipments ADD CONSTRAINT fk_user_shipment FOREIGN KEY (user_id) REFERENCES users(id);